...
<div class="container">
  ...
  long-awaited <a href="http://www.irs.gov/pub/irs-drop/n-14-21.pdf"
  target="_blank">Guidance</a> on how to categorize cryptocurrencies for 
  ...
  <p>
  Since the 2013-03-18 FinCEN <a href="http://www.fincen.gov/statutes_regs/guidance/html/FIN-2013-G001.html"
  target="_blank">Guidance on Virtual Currency</a>, accounting and
  ...
  <p>
  By declaring bitcoins to be <i>property</i>, and <i>not currency</i>, IRS officials have 
  ...
  <i>currency</i>, as Bitcoin supporters had hoped, this would have been the first 
  ...
  with no homeland. In all fairness, that is a lot to ask; from a regulatory perspetctive,
  it's so much easier to lump bitcoins together with comic books, collectable
  stamps, and <i>Magic: The Gathering</i> playing cards.
  </p>
  ...
  <p>
  Intriguingly, this episode fits Richard Rahn's 1999 prediction in 
  <a href="http://www.abebooks.com/servlet/SearchResults?an=Rahn&sts=t&tn=End+of+Money"
  target="_blank"><i>The End of Money</i></a>:
  </p>

  <blockquote>
  In the future, trade will be executed by instantaneous and 
  ...
  <p>
  When seen in terms of <i>shares</i> rather than <i>coins</i> the tokens that a 
  ...
  the holders of bitcoin-the-unit own <i>non-voting capital shares</i>. The
  ...
  <p>
  Granted, Bitcoin developers <i>could</i> replace POW with POS, but they would 
  ...
  from which we spend, e.g., <i>$X worth of bitcoins</i>, rather than <i>Y bitcoins</i>.
  ...
  as <i>property</i>, clinging to this One True analogy and railing against those 
