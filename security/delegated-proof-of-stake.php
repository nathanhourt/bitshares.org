  ...
  <div class="container">
    ...
    <div class="row">
       ...
       <div class="col-lg-8">
         ...
         verified by 100% of the shareholders through their delegates.
         </p>
       </div>
    </div>
    <div class="row">
    ...
    Every share can be set to vote either <b><i>for</i></b> or <b><i>against</i></b> a potential delegate.  Delegates are ranked by (VOTES_FOR - VOTES_AGAINST).   Every client connected to the network can observe the behavior of all delegates and detect the following bad behaviors automatically:
    </p>
       
    <ol>
       <li><p> Failure to include valid transactions that were broadcast more than 1 minute prior to the production of the block.   One minute should be more than enough propagation time for all delegates to receive the transaction because their role requires them to be well connected to the network.  </p> </li>
       <li><p> Failure to produce a block before the end of their window.</p></li>
       <li><p> Failure to reference prior blocks that were produced and distributed  in time.</p></li>
       <li><p> Signing an invalid block. </p></li>
    </ol>
    <p>
    ...
    <h4>2.5 Are 100 Delegates Decentralized?</h4>
    <p>
    ...
    <h4>3.2 Centralizing power in a few Delegates </h4>
    <p>
   ...
   <h3>5.0 High Quality of Service </h3>
    <p> 
   Assuming a DPOS system had a $10 billion market cap and the average annual transaction fees were 0.25% and delegates combined earned 10% of all transaction fees, then each delegate would be earning $25,000 per year just to keep their node on the network.  
   </p>
    <p>
   This is a very profitable role and one which many people will be constantly competing to acquire.  This means that everyone who wants a job will be actively looking for ways to steal support from those with the job.  They would do this through performing statistical analysis of the behavior of delegates to find any deviation from the standard algorithms.   Once a bias is found they can hopefully win some votes.    
   </p>
   <p>
   ...
   <p>
   In effect the market competition will result in the most creative possible solutions of ensuring the integrity and reliability of the delegates.   There is much to gain by working to make the network more secure, but little to gain by attempting to disrupt the network.   
   </p>
